...
do
	...
	/home/ubuntu/torch/install/bin/th train.lua -input_h5 ../neuraltalk2-data/dataset/salone-3/cocotalk.h5 -input_json ../neuraltalk2-data/dataset/salone-3/cocotalk.json -checkpoint_path ../neuraltalk2-data/checkpoints -id 3 -finetune_cnn_after 0 -start_from ../neuraltalk2-data/checkpoints/model_id3.t7 -max_iters 2501 -save_checkpoint_every 2500 -batch_size 10
